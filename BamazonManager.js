...
//I m using prompt package instead of inquirer
var managerOptions = {
	properties:{
		mOptions:{
			description: colors.red ('Hello Manager: \n Key in one of the following options: \n 1 for Products Report \n 2 to Generate Low Inventory Report  \n 3 to add to Inventory \n 4 to add New Product \n 5 to Exit')
		},
	},
};
...
var viewProducts = function(){
	...
	connection.query('SELECT * FROM Products', function(err, res){
		...
		var table = new Table({
			head: ['Item Id#', 'Product Name', 'Department', 'Price $', 'Units left'],
			style: {
				head: ['blue'],
				compact: false,
				colAligns: ['center'],
